import{b as E,e as A}from"./index-a3IjaFud.js";const w=["progress","pulse","false"],x=["circle","rect","text"],a={COUNT:1,VARIANT:"text",ANIMATION:"progress"},e={DATA_BUSY:"true",DATA_VALUEMIN:"0",DATA_VALUEMAX:"100",DATA_VALUETEXT:"Loading...",ROLE:"progressbar",TABINDEX:"0"},s={CIRCLE:"circle",RECT:"rect"},p={PROGRESS:"progress",PULSE:"pulse"},I=`.skeleton {
